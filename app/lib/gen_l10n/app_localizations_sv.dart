...
class AppLocalizationsSv extends AppLocalizations {
  ...
  String get registerResearchInformation =>
      'Verktyg, kunskap och stöd för Hälsosam livsstil efter ryggmärgsskada.\n\nVi vill ge dig information om den del av studien som rör vår Livsstilsapp och hur den kommer att användas för att samla in data och främja hälsosamma vanor.\n\nLivsstilsappen och Forskning: Appen är en viktig del av vårt forskningsprojekt och den är utformad för att vara en användarvänlig, omfattande plattform för att framställa olika aspekter av deltagarnas hälsa och livsstil. Genom att titta på hur objektivt mätt aktivitetsnivåer, energiförbrukning, stillasittande (aktivitetsband) samt självrapporterad smärta, blås- och tarm funktion, spasticitet, trycksår och neurogen smärta. Appen är ett värdefullt verktyg som hjälper dig att optimera din träning och hälsa, minska risken för komplikationer och förbättra din livskvalitet. I Livsstilsappen kommer du att kunna registrera information om olika komplikationer som kan uppstå efter en ryggmärgsskada, till exempel smärta, spasticitet och blås- och tarmfunktion. Du väljer själv vilka komplikationer du vill registrera. I Livsstilsappen har du möjlighet att se din historik samlat i ett grafiskt gränssnitt och på så sätt titta på hur olika faktorer påverkar komplikationer och livskvalitet. Du kan även, om du vill, visa statistik från Livsstilsappen när du möter vårdpersonal. På så vis får ni tillsammans bättre möjlighet att skräddarsy din behandlingsplan, optimera din träning och förbättra din hälsa.\n\nDataanalys: De data som samlas in genom appen kommer att analyseras för att bättre förstå hur olika faktorer påverkar hälsan på gruppnivå hos personer med ryggmärgsskada. Dessa insikter kommer att vara vägledande för att utforma effektiva interventioner och stödsystem.\n\nSekretess och Datahantering: Vi försäkrar dig om att all data som samlas in genom appen kommer att behandlas konfidentiellt och anonymt. Vi kommer att vidta alla nödvändiga åtgärder för att säkerställa din integritet och datahanteringens säkerhet.\n\nDeltagandet är frivilligt: Ditt deltagande i forskningsprojektet är frivilligt och du kan när som helst välja att avbryta deltagandet. Om du väljer att inte delta eller vill avbryta ditt deltagande behöver du inte uppge varför, och det kommer inte heller att påverka din rehabilitering eller kontakt med vårdgivare. Om du vill avbryta ditt deltagande i forskningsprojektet ska du kontakta de ansvariga för projektet (se nedan).\n\nAnmälan och deltagande: Om du är intresserad av att delta, godkänner du att du tagit del av informationen i nästa steg. Om du vill ha ytterligare information före du bestämmer dig är du välkommen att ringa eller skriva till ansvariga forskare.\n\nTobias Holmlund, Neurobiologi, vårdvetenskap och samhälle, Fysioterapi, Karolinska Institutet, Alfred Nobels allé 23, tel 08-52488820, e-mail tobias.holmlund@ki.se';
  ...
  String get registerConsentCheckbox =>
      'Jag har läst informationen och samtycker till att mina data delas och används i forskningsprojektet.';
